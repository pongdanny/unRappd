...
def seed_checkins():
    ...
    checkin1 = Checkin(userId="1", songId="8", review="got this song on repeat!", rating="5")
    checkin2 = Checkin(userId="2", songId="2", review="Yo, this guy's flow is INSANE!", rating="5")
    checkin3 = Checkin(userId="3", songId="12", review="cant stop bumpin this track!", rating="5")
    checkin4 = Checkin(userId="4", songId="10", review="vibin out to this right now :)", rating="5")
    checkin5 = Checkin(userId="5", songId="6", review="BRO THIS GUY GOT BARS!!!", rating="5")
    checkin6 = Checkin(userId="6", songId="16", review="my new fav song right hurr!", rating="5")
